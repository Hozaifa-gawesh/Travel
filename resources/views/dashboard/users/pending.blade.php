    ...
    <div class="page-content-wrapper users">
        <div class="page-content">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <span class="active">{{ __('lang.pending_users') }}</span>
                </li>
            </ul>
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                            <div class="item_box">
                                ...
                                <div class="item_info text-center">
                                    ...
                                    <a href="{{ route('confirm-user', $get->id) }}" title="{{ __('lang.approve') }}" class="view_details confirm-btn icon_item green_icon"><i class="icon-check"></i></a>
                                </div>
                            </div>
                        </div>
                    @endforeach
