@php $titlePage = __('lang.edit_hotel'); @endphp
                    ...
                    <div class="tab-pane" id="tab_2">
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body form">
                                ...
                                <form method="post" action="{{ route('update-hotel', $data->id) }}" enctype="multipart/form-data">
                                    @csrf
                                                    ...
                                                    <div class="tab-pane fade active in" id="General">
                                                        <div class="col-md-12">
                                                            <div class="form-group {{ $errors->has('services') ? 'has-error' : '' }}">
                                                                ...
                                                                <input id="OldServices" value="{{ json_encode(old('services', json_decode($data->services))) }}" style="display: none;" type="hidden">
                                                            ...
                                                            <div class="form-group {{ $errors->has('country') ? 'has-error' : '' }}">
                                                                ...
                                                                <select name="country" id="country" class="form-control selectpicker" data-live-search="true">
                                                                    ...
                                                                    @foreach($countries as $get)
                                                                        <option {{ old('country', $data->city->country_id) == $get->id ? 'selected' : '' }} value="{{ $get->id }}">{{ $get->title }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="form-group {{ $errors->has('city_id') ? 'has-error' : '' }}">
                                                                ...
                                                                <select name="city_id" id="city_id" class="form-control selectpicker" data-live-search="true">
                                                                    ...
                                                                    @foreach($cities as $get)
                                                                        <option {{ old('city_id', $data->city_id) == $get->id ? 'selected' : '' }} value="{{ $get->id }}">{{ $get->title }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="tab-pane fade" id="English">
                                                        <div class="col-md-12">
                                                            <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                                                ...
                                                                <input type="text" id="title" name="title" value="{{ old('title', $data->title) }}" class="form-control" placeholder="Enter Title Hotel">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="clear"></div>
