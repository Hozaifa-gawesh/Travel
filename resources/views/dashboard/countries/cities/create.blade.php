@php $titlePage = __('lang.add_city'); @endphp
                    ...
                    <div class="tab-pane" id="tab_2">
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body form">
                                ...
                                <form method="post" action="{{ route('store-city-country', $data->id) }}" enctype="multipart/form-data">
                                    @csrf
                                                    ...
                                                    <div class="tab-pane fade" id="English">
                                                        <div class="col-md-12">
                                                            <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                                                                ...
                                                                <input type="text" id="title" name="title" value="{{ old('title') }}" class="form-control" placeholder="Enter Title City">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="clear"></div>
