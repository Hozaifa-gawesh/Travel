@php $titlePage = __('lang.countries'); @endphp
    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            <div class="page-head">
                ...
                <button data-toggle="modal" class="add_products FormDistrictAdd" data-target="#FormDistrict" title="{{ __('lang.add_item') }}" value="{{ route('store-country') }}"><i class="icon-plus"></i></button>
            </div>
                    ...
                    <div class="tab-pane" id="tab_2">
                        <div class="portlet light ">
                            ...
                            <div class="portlet-body form">
                                ...
                                <form action="{{ route('deletes-country') }}" method="post" id="form_multi">
                                    @csrf
                                    <table class="table table-bordered table-striped table-condensed flip-content">
                                        ...
                                        @foreach($data as $get)
                                            <tr>
                                                ...
                                                <td>{{ $get->title }}</td>
                                                <td>{{ $get->cities_count }}</td>
                                                <td>
                                                    <a title="View" href="{{ route('view-country', $get->id) }}" class="btn yellow_icon icon_item btn-warning"><i class="fa fa-eye"></i></a>
                                                    <button type="button" data-toggle="modal" data-target="#FormDistrict" value="{{ route('update-country', $get->id) }}" title="Edit" data-id="{{ $get->id }}" class="btn btn-info blue_icon FormDistrictEdit"><i class="fa fa-edit"></i></button>
                                                    <a title="Delete" href="javascript:;" data-url="{{ route('delete-country', $get->id) }}" class="btn btn-danger confirmAjax"><i class="fa fa-trash"></i></a>
                                                </td>
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="rule_form">
                                                            <h3 style="margin-bottom: 15px;">{{ __('lang.country_info') }}:</h3>
