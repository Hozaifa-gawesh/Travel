    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <span class="active">{{ __('lang.add_place') }}</span>
                </li>
            </ul>
            <div class="row">
                <div class="col-md-12">
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title tabbable-line">
                                        <div class="caption caption-md">
                                            ...
                                            <span class="caption-subject font-blue-madison bold uppercase">{{ __('lang.add_place') }}</span>
                                        </div>
                                    </div>
                                                            ...
                                                            <div class="col-md-12">
                                                                    ...
                                                                    <div class="form-group {{ $errors->has('city_id') ? 'has-error' : '' }}">
                                                                        ...
                                                                        <select id="city_id" name="city_id" data-live-search="true" class="form-control bs-select">
                                                                            ...
                                                                            @foreach($cities as $get)
                                                                                <option {{ $get->id == old('city_id') ? 'selected' : '' }} value="{{ $get->id }}">{{ $get->title }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group {{ $errors->has('area_id') ? 'has-error' : '' }}">
                                                                        ...
                                                                        <select id="area_id" disabled name="area_id" data-live-search="true" class="form-control bs-select">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group {{ $errors->has('from') ? 'has-error' : '' }}">
                                                                        ...
                                                                        <input type="number" name="from" id="from" step="1" min="1" value="{{ old('from') }}" class="form-control IntVal" placeholder="{{ __('lang.enter') }} {{ __('lang.delivery_on_from') }} {{ __('lang.days') }} {{ __('lang.ex') }}:(2)" />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group {{ $errors->has('to') ? 'has-error' : '' }}">
                                                                        ...
                                                                        <input type="number" name="to" id="to" step="1" value="{{ old('to') }}" class="form-control IntVal" placeholder="{{ __('lang.enter') }} {{ __('lang.delivery_on_to') }} {{ __('lang.days') }} {{ __('lang.ex') }}:(5)" />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group {{ $errors->has('price') ? 'has-error' : '' }}">
                                                                        ...
                                                                        <input type="number" name="price" id="price" step="1" value="{{ old('price') }}" class="form-control IntVal" placeholder="{{ __('lang.enter') }} {{ __('lang.price') }} " />
                                                                    </div>
                                                                </div>
